...
class Blog
{
    ...
    public $blog_author;
    public $blog_author_information;
        ...
        public function create()
        {
            try {
                ...
                $query->execute([
                    ...
                    "blog_author_information" => $this->blog_author_information,
    ...
    public function update()
    {
        try {
            ...
            $sql .= "blog_author_information = :blog_author_information, ";
