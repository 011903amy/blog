            ...
            <div className="mb-10">
              <div className="work-top grid grid-cols-2 mb-10 ">
                <div className="card-sm pr-5">
                  <Link to="/">
                    <img
                      src="https://cdn.prod.website-files.com/63661389dd2417776f0d89fb/6369fae804b5b0ea36ed1d10_project-02-p-800.webp"
                      alt=""
                      className="rounded-xl"
                    />
                  </Link>
                ...
                <div className="card-sm pl-5 border-l border-light">
                  <Link to="/">
                    <img
                      src="https://cdn.prod.website-files.com/63661389dd2417776f0d89fb/6369fadaaa89f63186350b73_project-03-p-800.webp"
                      alt=""
                      className="rounded-xl"
                    />
                  </Link>
            ...
            <div className="mb-10">
              <div className="work-top grid grid-cols-2 mb-10 ">
                <div className="card-sm pr-5">
                  <Link to="/">
                    <img
                      src="https://cdn.prod.website-files.com/63661389dd2417776f0d89fb/6369fab6fb2692808936e774_project-04-p-800.webp"
                      alt=""
                      className="rounded-xl"
                    />
                  </Link>
                ...
                <div className="card-sm pl-5 border-l border-light">
                  <Link to="/">
                    <img
                      src="https://cdn.prod.website-files.com/63661389dd2417776f0d89fb/6369faafe81233326efbe2c5_project-05-p-800.webp"
                      alt=""
                      className="rounded-xl"
                    />
                  </Link>
